...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{asset('css/plugins.css?v=2.2')}}"/>
    <!-- Main Styles -->
    <link rel="stylesheet" href="{{asset('css/theme.css?v=2.2')}}"/>
    <!-- Color Skins -->
    ...
    <style type="text/css">
        ...
        #navigation.modern .columns ul.dropdown-menu.mega-menu li a{ padding:3px 15px; font-size: 12px; font-weight: 400; }
        #navigation.modern .columns ul.dropdown-menu li a{ font-size: 12px; font-weight: 400 !important; }
...
<nav id="navigation" class="white-nav shrink modern hover4 radius-drop" data-offset="55">
    ...
    <div id="extranav" data-showme="#blog" data-hideme="#hide-extranav" class="bg-gradient1 font-12 bold uppercase white">
        <div class="container-xl clearfix">
            ...
            <!-- Nav menu -->
            <div class="nav-menu f-right w-auto no-pm t-right">
                <ul class="nav clearfix">
                    <li><a href="#top">Home</a></li>
                    <li><a href="https://themeforest.net/item/quadra-creative-multipurpose-template/21409528" target="_blank" class="large-btn white bg-white-hover dark-hover bg-warning">buy this theme</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="icon-navigation hidden-sm hidden-xs nav-menu bg-gradient1 font-17 white radius bs-lg opacity-hover-reverse skrollr" data-0="top:22%; left:5%; opacity:0;" data-600="opacity:0;" data-800="opacity:1;" data-end="top:45%;">
    <ul class="nav">
        <li data-toggle="popover" data-trigger="hover" title="Home" data-placement="right">
            <a href="#home" class="fa fa-home click-effect"></a>
        </li>
        <li data-toggle="popover" data-trigger="hover" title="My Favorite!" data-placement="right">
            <a href="#hide-extranav" class="fa fa-heart click-effect"></a>
        </li>
        <li data-toggle="popover" data-trigger="hover" title="Buy This Theme" data-placement="right">
            <a href="https://themeforest.net/item/quadra-creative-multipurpose-template/21409528" target="_blank" class="fa fa-cart-plus click-effect"></a>
        </li>
        <li data-toggle="popover" data-trigger="hover" title="Subscribe Us" data-placement="right">
            <a href="#footer" class="fa fa-user-circle click-effect"></a>
        </li>
        <li data-toggle="popover" data-trigger="hover" title="Drop Us a Message" data-placement="right">
            <a href="#" class="fa stay fa-envelope quick-contact-form-trigger click-effect"></a>
        </li>
    </ul>
</div>
<!-- End Icon Navigation -->
...
<div class="quick-contact-form border-colored">
    ...
    <form class="quick_form" name="quick_form" method="post" action="php/quick-contact-form.php">
        ...
        <!-- Send Button -->
        <button type="submit" id="qsubmit" class="bg-colored click-effect white qdr-hover-2-rotate uppercase extrabold">Send</button>
        <!-- End Send Button -->
    </form>
    <!-- End Form -->
...
<script type="text/javascript" src="{{asset('js/scripts.js?v=2.2')}}"></script>
<!-- END JS FILES -->
